    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        #hero {
            ...
            position: relative;
            overflow: hidden;
            background-image: url('/images/photo-connexion.png');
        ...
        #hero::after {
            ...
            position: absolute;
            inset: 0;
            background: linear-gradient(to top, rgba(8,8,8,0.95) 0%, rgba(8,8,8,0.5) 50%, rgba(8,8,8,0.3) 100%);
            z-index: 1;
            pointer-events: none;
        }
        #particle-canvas {
        ...
        .hero-bottom {
            ...
            opacity: 0;
            animation: revealUp 0.8s ease forwards 0.9s;
        }
        ...
        .scroll-hint {
            ...
            gap: 8px;
            opacity: 0;
            animation: revealUp 0.8s ease forwards 1.4s;
        }
        .scroll-hint span {
            font-family: 'Space Mono', monospace;
            font-size: 9px;
...
<script>
    ...
    function drawParticles() {
        ...
        particles.forEach(p => {
            ...
            particles.forEach(p2 => {
                ...
                if (dist < 120) {
                    ctx.beginPath();
                    ctx.strokeStyle = `rgba(200,241,53,${0.06 * (1 - dist/120)})`;
                    ctx.lineWidth = 0.5;
                    ctx.moveTo(p.x, p.y);
    ...
    document.querySelectorAll('.stat-card, .feature-card, .cta-section, .city-tag')
