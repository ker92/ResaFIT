...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .left-panel::after { content: ''; position: absolute; inset: 0; background: linear-gradient(135deg, rgba(8,8,8,0.7) 0%, rgba(8,8,8,0.3) 100%); }
        ...
        .right-panel { background: var(--dark); display: flex; align-items: center; justify-content: center; padding: 48px; position: relative; }
        ...
        .form-subtitle { font-size: 14px; color: var(--gray); margin-bottom: 40px; opacity: 0; animation: revealUp 0.6s ease forwards 0.3s; }
        ...
        .field { margin-bottom: 20px; opacity: 0; animation: revealUp 0.6s ease forwards; }
        ...
        .divider { display: flex; align-items: center; gap: 16px; margin: 28px 0; opacity: 0; animation: revealUp 0.6s ease forwards 0.8s; }
        .divider::before, .divider::after { content: ''; flex: 1; height: 1px; background: rgba(255,255,255,0.08); }
        .divider span { font-size: 11px; color: var(--gray); letter-spacing: 2px; text-transform: uppercase; }

        .register-link { text-align: center; font-size: 13px; color: var(--gray); opacity: 0; animation: revealUp 0.6s ease forwards 0.9s; }
        .register-link a { color: var(--acid); text-decoration: none; font-weight: 500; transition: opacity 0.2s; }
...
<div class="left-panel">
    <div class="left-content">
        ...
        <div class="left-tagline">
            <h2>Bienvenue<br>de <span>retour</span></h2>
            <p>Connectez-vous pour accéder à vos cours, réservations et votre QR code d'accès.</p>
        </div>
        <div class="left-stats">
            <div class="left-stat"><div class="num">12K+</div><div class="lbl">Membres</div></div>
            <div class="left-stat"><div class="num">340</div><div class="lbl">Salles</div></div>
            <div class="left-stat"><div class="num">98%</div><div class="lbl">Satisfaits</div></div>
        </div>
    </div>
</div>
...
<div class="right-panel">
    <div class="form-container">
        ...
        <p class="form-eyebrow"><i class="fa-solid fa-bolt" style="margin-right:6px"></i>Espace membre</p>
