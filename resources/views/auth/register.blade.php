...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .field input { width: 100%; background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.1); padding: 16px 16px 16px 44px; border-radius: 12px; color: var(--light); font-family: 'DM Sans', sans-serif; font-size: 14px; outline: none; transition: all 0.2s; }
    ...
    <div class="left-content">
        ...
        <div class="left-features">
            ...
            <div class="left-feature">
                ...
                <div class="left-feature-text">
                    <strong>QR Code personnel</strong>
                    Accès instantané aux salles partenaires
                </div>
            </div>
            <div class="left-feature">
                <div class="left-feature-icon"><i class="fa-solid fa-earth-americas"></i></div>
                <div class="left-feature-text">
                    <strong>340+ salles partenaires</strong>
                    Paris, Londres, New York, Tokyo et plus
                </div>
            </div>
        </div>
    </div>
