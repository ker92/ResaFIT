...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::post('/reservation/{id}/validate', [AdminController::class, 'validateReservation'])->name('reservation.validate');
    Route::post('/reservation/{id}/reject',   [AdminController::class, 'rejectReservation'])->name('reservation.reject');
